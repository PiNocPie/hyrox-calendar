...
export const workouts = {
  ...
  '2026-04-28': { type: 'strength', title: 'Strength - Pull', badge: '60-75 min', content: '🎯 สร้างแรงดึง — ช่วย Sled Pull, Row, SkiErg ทำได้เร็วขึ้น\n\nSeated Row: 4x10 @ 47.5kg 🔥\nLat Pulldown: 4x10 @ 52.5kg\nBack Extension: 3x12 + 12.5kg\n\nFinisher:\nWall Balls: 3x25 @ 9kg' },
  ...
  '2026-06-01': { type: 'run', title: 'Long Run', badge: '50-60 min', content: '🎯 สร้างความอดทน — ร่างกายชินกับวิ่งนานเหมือนวันแข่ง\n\nZone 2: 50-60 min\nRebuilding base' },
  ...
  '2026-06-18': { type: 'strength', title: 'Strength - Push + Legs', badge: '60-75 min', content: '🎯 สร้างแรงขา+ดัน — ช่วย Sled Push, Lunges, Wall Balls\n\nChest Press: 4x10 @ 55kg\nWeighted Step Up: 4x10/leg @ 16kg/hand\nLeg Curl: 4x10 @ 50kg\n\nEMOM 12 min (rotate):\nMin 1 — Wall Balls: 15 @ 9kg\nMin 2 — Burpees: 8 BW\nMin 3 — Run: 150m' },
  '2026-06-19': { type: 'run', title: 'Intervals', badge: '55-65 min', content: '🎯 เพิ่ม VO2max — วิ่งเร็วขึ้นที่ effort เท่าเดิม\n\nWarm-up: 10 min\n10x 400m @ sub-2 pace\nTreadmill: 10.5-11.0 km/h\nRest: 60s (race simulation!)' },
  ...
  '2026-06-22': { type: 'run', title: 'Long Run', badge: '90 min', content: '🎯 สร้างความอดทน — ร่างกายชินกับวิ่งนานเหมือนวันแข่ง\n\nZone 2: 100 min\nFull Hyrox run distance!' },
  ...
  '2026-06-27': { type: 'strength', title: 'Hyrox Stations', badge: '70-80 min', content: '🎯 ฝึก Hyrox stations เต็มน้ำหนัก — จับเวลาแต่ละ station\n\nFull weight all stations:\nSled Push/Pull: 6x30m\nFarmer Carry: 4x200m @ 32kg/hand\nWall Balls: 4x25 @ 9kg\nBurpees: 4x20 BW' },
  ...
  '2026-07-03': { type: 'strength', title: 'Strength - Push + Legs', badge: '60-75 min', content: '🎯 สร้างแรงขา+ดัน — ช่วย Sled Push, Lunges, Wall Balls\n\nChest Press: 4x8 @ 60kg TARGET!\nWeighted Step Up: 4x8/leg @ 18kg/hand\nLunges 100m @ 30kg → Run 1.5km\n\nEMOM 12 min (rotate):\nMin 1 — Wall Balls: 15 @ 9kg\nMin 2 — Lunges: 25m @ 30kg\nMin 3 — Run: 200m' },
  '2026-07-04': { type: 'run', title: 'Intervals', badge: '55-65 min', content: '🎯 เพิ่ม VO2max — วิ่งเร็วขึ้นที่ effort เท่าเดิม\n\nWarm-up: 10 min\n8x 800m @ race pace\nTreadmill: 10.5-11.0 km/h\nRest: 90s\nBig session!' },
  ...
  '2026-07-21': { type: 'strength', title: 'Hyrox Stations Light', badge: '50-60 min', content: '🎯 activation เบาๆ — เตรียมร่างกายก่อนแข่ง\n\nAll stations at 70%:\nSled Push/Pull: 3x30m\nFarmer Carry: 3x100m @ 28kg/hand\nWall Balls: 3x20 @ 9kg\nBurpees: 3x15 BW\nFocus on form and efficiency' },
  '2026-07-20': { type: 'run', title: 'Long Run', badge: '75-90 min', content: '🎯 สร้างความอดทน — ร่างกายชินกับวิ่งนานเหมือนวันแข่ง\n\nZone 2: 85-100 min\nMaintain base' },
  '2026-07-19': { type: 'rest', title: 'REST 🛌', badge: '', content: '🎯 ฟื้นตัว — กล้ามเนื้อซ่อมแซมและแข็งแรงขึ้น\n\nวันพัก — นอนให้พอ กินให้ดี' },

  // Late July - Final Build
  '2026-07-22': { type: 'strength', title: 'Strength - Pull', badge: 'AM Run + 60-75 min', content: '🎯 สร้างแรงดึง — ช่วย Sled Pull, Row, SkiErg ทำได้เร็วขึ้น\n\nAM — Zone 2 Run: 30 min @ 7.0 km/h\n\nPM:\nSeated Row: 4x8 @ 60kg 🔥\nLat Pulldown: 4x8 @ 60kg\nBack Extension: 3x10 + 25kg\n\nEMOM 10 min:\nOdd min — Wall Balls: 12 @ 9kg\nEven min — Burpees: 8 BW' },
  '2026-07-23': { type: 'run', title: 'Zone 2 + Erg', badge: '60-70 min', content: '🎯 cardio + strength รวม — ประหยัดเวลา ได้ทั้งวิ่งและเวท\n\nZone 2: 40 min\nSkiErg: 1000m\nRow: 1000m' },
  '2026-07-24': { type: 'strength', title: 'Strength - Push + Legs', badge: '60-75 min', content: '🎯 สร้างแรงขา+ดัน — ช่วย Sled Push, Lunges, Wall Balls\n\nChest Press: 4x8 @ 60kg\nWeighted Step Up: 4x8/leg @ 20kg/hand\nBurpees 50 → Run 1km\n\nEMOM 12 min (rotate):\nMin 1 — Wall Balls: 15 @ 9kg\nMin 2 — Lunges: 25m @ 30kg\nMin 3 — Run: 200m' },
  '2026-07-25': { type: 'run', title: 'Intervals', badge: '55-65 min', content: '🎯 เพิ่ม VO2max — วิ่งเร็วขึ้นที่ effort เท่าเดิม\n\n8x 600m @ race pace\nRest: 75s\nBig aerobic session' },
  ...
  '2026-07-27': { type: 'run', title: 'Long Run', badge: '80-90 min', content: '🎯 สร้างความอดทน — ร่างกายชินกับวิ่งนานเหมือนวันแข่ง\n\nZone 2: 90-100 min\nLast long run before taper' },
  ...
  '2026-08-03': { type: 'strength', title: 'Light Stations', badge: '45-50 min', content: '🎯 activation เบาๆ — เตรียมร่างกายก่อนแข่ง\n\nAll Hyrox stations at 60%:\nSled Push/Pull: 2x25m\nFarmer Carry: 2x100m @ 24kg/hand\nWall Balls: 2x15 @ 9kg\nBurpees: 2x10 BW\nTechnique focus — no fatigue' },
