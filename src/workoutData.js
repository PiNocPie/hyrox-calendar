...
export const workouts = {
  ...
  '2026-07-27': { type: 'run', title: 'Long Run', badge: '60-70 min (DELOAD)', content: '🎯 สร้างความอดทน — ร่างกายชินกับวิ่งนานเหมือนวันแข่ง\n\nZone 2: 60-70 min\nDELOAD week — volume ลด 40%' },
