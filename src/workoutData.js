...
export const workouts = {
  ...
  // Week 7: Peak Week
  '2026-05-05': { type: 'strength', title: 'Strength - Upper PEAK', badge: '60-75 min', content: '🎯 สร้างแรง upper — Sled Pull, Row, SkiErg, Wall Balls\n👟 รองเท้า: Adidas Dropset 3\n\n⏱ พัก: Compound 90s / Isolation 60s / Dead Hang 60s\n\nSeated Row: 5x4 @ 55kg 🔥 PEAK\nLat Pulldown: 5x4 @ 60kg\nBack Extension: 3x10 + 15kg\nHeavy but controlled\nPull-ups: 5x3 BW\nNegative Pull-ups: 3x5 (jump up, 3-5s slow down)\nDead Hang: 3x max BW\n\nFinisher:\nWall Balls: 3x20 @ 9kg (overload — แข่ง 6kg)\nAlt: Wall Ball 6kg / DB Thruster 6-8kg/hand / Goblet Squat+Press 10-12kg\n\nCore:\nHanging Knee Raise: 3x10 BW\n\nPush:\n⏱ พัก: 60s\n\nChest Press: 4x8 @ 50kg\nEMOM 10 min:\nOdd min — Wall Balls: 12 @ 9kg (alt: 6kg / DB Thruster)\nEven min — Burpees: 6 BW\n\nCore:\nPallof Press: 3x12/side @ 10kg' },
  ...
  '2026-06-05': { type: 'run', title: 'Running Intervals', badge: '50-60 min', content: '🎯 เพิ่ม VO2max — วิ่งเร็วขึ้นที่ effort เท่าเดิม\n👟 รองเท้า: Asics Magic Speed 4\n\nWarm-up: 10 min\n8x 400m @ sub-2 target pace (< 7:30/km)\nTreadmill: 10.5-11.0 km/h\nRest: 75s' },
  ...
  // Week continues...
  '2026-06-09': { type: 'strength', title: 'Strength - Upper', badge: '90-105 min', content: '🎯 สร้างแรง upper — Sled Pull, Row, SkiErg, Wall Balls\n👟 รองเท้า: Adidas Dropset 3\n\n⏱ พัก: Sled 120s / Carry 90s / อื่นๆ 60s\n\nZone 2 Run: 30 min @ 6.5 km/h\n\nSeated Row: 5x5 @ 60kg 🔥\nLat Pulldown: 5x5 @ 65kg\nBack Extension: 3x15 + 15kg\nPull-ups: 5x3 BW\nNegative Pull-ups: 3x5 (jump up, 3-5s slow down)\nDead Hang: 3x max\n\nCore:\nPlank: 3x45s BW + Dead Bug: 3x10/side BW\n\nPush:\n⏱ พัก: 60s\n\nChest Press: 4x12 @ 50kg\nEMOM 10 min:\nOdd min — Wall Balls: 12 @ 9kg (alt: 6kg / DB Thruster)\nEven min — Lunges: 20m @ 30kg\n\nCore:\nHanging Knee Raise: 3x10 BW' },
  ...
  '2026-06-13': { type: 'strength', title: 'Hyrox Stations', badge: '75-80 min', content: '🎯 ฝึก Hyrox stations เต็มน้ำหนัก — จับเวลาแต่ละ station\n👟 รองเท้า: Adidas Dropset 3\n\n⏱ พัก: Sled 120s / Carry 90s / อื่นๆ 60s\n\nSled Push: 5x30m @ 175kg\nSled Pull: 5x30m @ 120kg\nFarmer Carry: 5x 200m @ 32kg/hand\n\nWall Balls: 75 total @ 9kg (overload — แข่ง 6kg)\nAlt: Wall Ball 6kg / DB Thruster 6-8kg/hand / Goblet Squat+Press 10-12kg\n\nCore:\nPallof Press: 3x12/side @ 10kg' },
  ...
  // Continue building...
  '2026-06-16': { type: 'strength', title: 'Strength - Upper', badge: '90-105 min', content: '🎯 สร้างแรง upper — Sled Pull, Row, SkiErg, Wall Balls\n👟 รองเท้า: Adidas Dropset 3\n\n⏱ พัก: Sled 120s / Carry 90s / อื่นๆ 60s\n\nZone 2 Run: 30 min @ 7.0 km/h\n\nSeated Row: 4x10 @ 55kg 🔥 MILESTONE!\nLat Pulldown: 4x10 @ 60kg\nBack Extension: 3x12 + 20kg\nPull-ups: 5x3 BW\nNegative Pull-ups: 3x5 (jump up, 3-5s slow down)\nDead Hang: 3x max BW\n\nCore:\nPallof Press: 3x12/side @ 10kg\n\nPush:\n⏱ พัก: 60s\n\nChest Press: 4x10 @ 55kg\nWall Balls: 50 unbroken @ 9kg (overload — แข่ง 6kg)\nAlt: Wall Ball 6kg / DB Thruster 6-8kg/hand / Goblet Squat+Press 10-12kg\n\nEMOM 12 min (rotate):\nMin 1 — Wall Balls: 15 @ 9kg (alt: 6kg / DB Thruster)\nMin 2 — Burpees: 8 BW\nMin 3 — Run: 150m\n\nCore:\nPlank: 3x45s BW + Dead Bug: 3x10/side BW' },
  ...
  '2026-06-19': { type: 'run', title: 'Running Intervals', badge: '55-65 min', content: '🎯 เพิ่ม VO2max — วิ่งเร็วขึ้นที่ effort เท่าเดิม\n👟 รองเท้า: Asics Magic Speed 4\n\n⏱ พัก: ระหว่าง station 60-90s (จำลองแข่ง)\n\nWarm-up: 10 min\n10x 400m @ sub-2 pace\nTreadmill: 10.5-11.0 km/h\nRest: 60s (race simulation!)' },
  ...
  '2026-06-23': { type: 'strength', title: 'Strength - Upper', badge: '90-105 min', content: '🎯 สร้างแรง upper — Sled Pull, Row, SkiErg, Wall Balls\n👟 รองเท้า: Adidas Dropset 3\n\n⏱ พัก: Sled 120s / Carry 90s / อื่นๆ 60s\n\nZone 2 Run: 30 min @ 7.0 km/h\n\nSeated Row: 5x4 @ 65kg 🔥\nLat Pulldown: 5x4 @ 70kg\nBack Extension: 3x12 + 20kg\nPull-ups: 5x3 BW\nNegative Pull-ups: 3x5 (jump up, 3-5s slow down)\nDead Hang: 3x max BW\n\nCore:\nHanging Knee Raise: 3x10 BW\n\nPush:\n⏱ พัก: 60s\n\nChest Press: 4x10 @ 55kg\nWall Balls: 100 total @ 9kg (overload — แข่ง 6kg)\nAlt: Wall Ball 6kg / DB Thruster 6-8kg/hand / Goblet Squat+Press 10-12kg\n\nEMOM 12 min (rotate):\nMin 1 — Run: 200m\nMin 2 — Wall Balls: 12 @ 9kg (alt: 6kg / DB Thruster)\nMin 3 — Burpees: 8 BW\n\nCore:\nPallof Press: 3x12/side @ 10kg' },
  ...
  '2026-07-04': { type: 'run', title: 'Running Intervals', badge: '55-65 min', content: '🎯 เพิ่ม VO2max — วิ่งเร็วขึ้นที่ effort เท่าเดิม\n👟 รองเท้า: Asics Magic Speed 4\n\nWarm-up: 10 min\n8x 800m @ race pace\nTreadmill: 10.5-11.0 km/h\nRest: 90s\nBig session!' },
  ...
  '2026-07-21': { type: 'strength', title: 'Hyrox Stations Light', badge: '60-65 min', content: '🎯 activation เบาๆ — เตรียมร่างกายก่อนแข่ง\n👟 รองเท้า: Adidas Dropset 3\n\n⏱ พัก: Sled 120s / Carry 90s / อื่นๆ 60s\n\nAll stations at 70%:\nSled Push: 3x30m @ 175kg\nSled Pull: 3x30m @ 120kg\nFarmer Carry: 3x100m @ 28kg/hand\n\nWall Balls: 50 unbroken @ 9kg (overload — แข่ง 6kg)\nAlt: Wall Ball 6kg / DB Thruster 6-8kg/hand / Goblet Squat+Press 10-12kg\nBurpees: 3x15 BW\nFocus on form and efficiency\n\nCore:\nPlank: 3x45s BW + Dead Bug: 3x10/side BW' },
  ...
  '2026-07-22': { type: 'strength', title: 'Strength - Upper (DELOAD)', badge: '90-105 min', content: '🎯 สร้างแรง upper — Sled Pull, Row, SkiErg, Wall Balls\n👟 รองเท้า: Adidas Dropset 3\n\n⏱ พัก: Sled 120s / Carry 90s / อื่นๆ 60s\n\nZone 2 Run: 30 min @ 7.0 km/h\n\nSeated Row: 3x6 @ 50kg 🔥\nLat Pulldown: 3x6 @ 55kg\nBack Extension: 2x8 + 20kg\nPull-ups: 5x3 BW\nNegative Pull-ups: 3x5 (jump up, 3-5s slow down)\nDead Hang: 3x max BW\n\nEMOM 10 min:\nOdd min — Wall Balls: 12 @ 9kg (alt: 6kg / DB Thruster)\nEven min — Burpees: 8 BW\n\nCore:\nPallof Press: 3x12/side @ 10kg\n\nTransition Drill:\nRun 400m → Sled Pull 25m → Run 400m\n\nPush:\n⏱ พัก: 60s\n\nChest Press: 4x8 @ 60kg\nEMOM 12 min (rotate):\nMin 1 — Wall Balls: 15 @ 9kg (alt: 6kg / DB Thruster)\nMin 2 — Lunges: 25m @ 30kg\nMin 3 — Run: 200m\n\nCore:\nPlank: 3x45s BW + Dead Bug: 3x10/side BW' },
  ...
  '2026-07-25': { type: 'run', title: 'Running Intervals', badge: '55-65 min', content: '🎯 เพิ่ม VO2max — วิ่งเร็วขึ้นที่ effort เท่าเดิม\n👟 รองเท้า: Asics Magic Speed 4\n\n8x 600m @ race pace\nRest: 75s\nBig aerobic session' },
