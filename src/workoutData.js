...
export const workouts = {
  ...
  '2026-03-28': { type: 'run', title: 'Long Run', badge: '50-65 min', content: 'Zone 2: 60-75 min\nPace: 7:00-7:30 /km\nTreadmill: 6.5 km/h\nHR: 130-145 bpm\n\nCool-down + Foam Roll 10 min' },
  ...
  '2026-04-01': { type: 'strength', title: 'Strength - Push + Legs', badge: '60-75 min', content: 'Chest Press: 4x10 @ 42.5kg\nHip Thrust: 4x10 @ 65kg\nLeg Curl: 3x12 @ 42.5kg\nWalking Lunges: 3x12/leg @ 30kg\n\nFinisher:\nWall Balls: 3x15 @ 9kg' },
  ...
  '2026-04-04': { type: 'run', title: 'Long Run', badge: '60-75 min', content: 'Zone 2: 70-85 min\nPace: 7:00-7:30 /km\nTreadmill: 6.5 km/h' },
  ...
  '2026-04-07': { type: 'run', title: 'Tempo Run + Upper', badge: '60-70 min', content: 'Tempo Run: 25 min @ 6:30-7:00/km\nTreadmill: 9.0-9.5 km/h\nHR: 155-165 bpm\nFeel: พูดได้แค่สั้นๆ\n\nUpper:\nChest Press: 4x10 @ 45kg\nRope Tricep Pushdown: 3x12 @ 20kg\nCable Curl: 3x12 @ 15kg' },
  ...
  '2026-04-13': { type: 'nogym', title: '🏠 Home: Long Run', badge: 'No Gym', content: 'Long Run Zone 2: 70-85 min\nOR\nActive Recovery: Walk 45 min + Stretch 20 min\n\nฟังร่างกาย!' },
  ...
  '2026-04-22': { type: 'run', title: 'Tempo Run + Upper', badge: '60-70 min', content: 'Tempo Run: 25 min @ 6:30-7:00/km\nTreadmill: 9.0-9.5 km/h\nHR: 155-165 bpm\n\nUpper:\nChest Press: 3x10 @ 47.5kg\nFace Pull: 3x15 @ 15kg\nRope Tricep Pushdown: 3x12 @ 22.5kg\nCable Curl: 3x12 @ 15kg' },
  '2026-04-23': { type: 'strength', title: 'Strength - Push + Legs', badge: '60-75 min', content: 'Chest Press: 4x10 @ 47.5kg\nHip Thrust: 4x10 @ 75kg\nLeg Curl: 3x12 @ 45kg\nLunges: 3x12/leg @ 30kg\nBurpees 40 → Run 800m (cramp drill)\n\nFinisher:\nWall Balls: 3x25 @ 9kg' },
  ...
  '2026-04-27': { type: 'run', title: 'Long Run', badge: '75-90 min', content: 'Zone 2: 85-100 min\nPace: 6:45-7:15 /km\nTreadmill: 9.0-9.5 km/h' },
  ...
  '2026-05-04': { type: 'run', title: 'Long Run', badge: '70-80 min', content: 'Zone 2: 80-90 min\nPace: 6:45-7:15 /km\nTreadmill: 9.0-9.5 km/h' },
  '2026-05-03': { type: 'rest', title: 'REST 🛌', badge: '', content: 'วันพัก — นอนให้พอ กินให้ดี' },

  // Week 7: Peak Week
  '2026-05-05': { type: 'strength', title: 'Strength - Pull PEAK', badge: '60-75 min', content: 'Seated Row: 4x8 @ 50kg 🔥 PEAK\nLat Pulldown: 4x8 @ 55kg\nBack Extension: 3x10 + 15kg\nHeavy but controlled\n\nFinisher:\nWall Balls: 3x20 @ 9kg' },
  '2026-05-06': { type: 'run', title: 'Tempo Run + Upper', badge: '60-70 min', content: 'Tempo Run: 25 min @ 6:20-6:50/km\nTreadmill: 9.0-9.5 km/h\nHR: 155-165 bpm\n\nUpper:\nChest Press: 4x8 @ 50kg\nRope Tricep Pushdown: 3x12 @ 22.5kg\nCable Curl: 3x12 @ 17.5kg' },
  '2026-05-07': { type: 'strength', title: 'Strength - Push + Legs', badge: '60-75 min', content: 'Chest Press: 4x8 @ 50kg\nHip Thrust: 4x8 @ 80kg\nLeg Curl: 3x10 @ 47.5kg\n\nEMOM 10 min:\nOdd min — Wall Balls: 12 @ 9kg\nEven min — Burpees: 6 BW' },
  ...
  '2026-05-14': { type: 'strength', title: 'Light Strength - Push', badge: '45-50 min', content: 'Chest Press: 3x8 @ 40kg\nHip Thrust: 3x8 @ 60kg\nMobility work' },
  ...
  '2026-06-06': { type: 'strength', title: 'Hyrox Simulation Partial', badge: '60-75 min', content: 'Hyrox Partial Simulation:\nRun 1km → SkiErg: 1000m\nRun 1km → Sled Push: 3x30m\nRun 1km → Sled Pull: 3x30m\nRun 1km → Row: 1000m\n\nWall Balls: 3x25 @ 9kg (finisher)\nFocus on transitions!' },
  '2026-06-08': { type: 'run', title: 'Long Run', badge: '75-90 min', content: 'Zone 2: 85-100 min\nBuilding for Hyrox distance' },
  '2026-06-07': { type: 'rest', title: 'REST 🛌', badge: '', content: 'วันพัก — นอนให้พอ กินให้ดี' },

  // Week continues...
  '2026-06-09': { type: 'strength', title: 'Strength - Pull', badge: 'AM Run + 60-75 min', content: 'AM — Zone 2 Run: 30 min @ 6.5 km/h\n\nPM:\nSeated Row: 4x10 @ 52.5kg 🔥\nLat Pulldown: 4x10 @ 57.5kg\nBack Extension: 3x12 + 17.5kg\nDead Hang: 3x max' },
  '2026-06-10': { type: 'run', title: 'Tempo Run + Upper', badge: '60-70 min', content: 'Tempo Run: 30 min @ 6:15-6:45/km\nTreadmill: 10.0-10.5 km/h\nHR: 155-165 bpm\n\nUpper:\nFace Pull: 3x15 @ 15kg\nRope Tricep Pushdown: 3x12 @ 25kg\nCable Curl: 3x12 @ 17.5kg' },
  '2026-06-11': { type: 'strength', title: 'Strength - Push + Legs', badge: '60-75 min', content: 'Chest Press: 4x10 @ 52.5kg\nHip Thrust: 4x10 @ 90kg\nLunges 100m @ 30kg → Run 1km (cramp drill)\n\nEMOM 10 min:\nOdd min — Wall Balls: 12 @ 9kg\nEven min — Lunges: 20m @ 30kg' },
  ...
  '2026-07-20': { type: 'run', title: 'Long Run', badge: '75-90 min', content: 'Zone 2: 85-100 min\nMaintain base' },
  '2026-07-19': { type: 'rest', title: 'REST 🛌', badge: '', content: 'วันพัก — นอนให้พอ กินให้ดี' },

  // Late July - Final Build
  '2026-07-22': { type: 'strength', title: 'Strength - Pull', badge: 'AM Run + 60-75 min', content: 'AM — Zone 2 Run: 30 min @ 7.0 km/h\n\nPM:\nSeated Row: 4x8 @ 60kg 🔥\nLat Pulldown: 4x8 @ 60kg\nBack Extension: 3x10 + 25kg\n\nEMOM 10 min:\nOdd min — Wall Balls: 12 @ 9kg\nEven min — Burpees: 8 BW' },
  '2026-07-23': { type: 'run', title: 'Zone 2 + Erg', badge: '60-70 min', content: 'Zone 2: 40 min\nSkiErg: 1000m\nRow: 1000m' },
  '2026-07-24': { type: 'strength', title: 'Strength - Push + Legs', badge: '60-75 min', content: 'Chest Press: 4x8 @ 60kg\nHip Thrust: 4x8 @ 110kg\nBurpees 50 → Run 1km\n\nEMOM 12 min (rotate):\nMin 1 — Wall Balls: 15 @ 9kg\nMin 2 — Lunges: 25m @ 30kg\nMin 3 — Run: 200m' },
  '2026-07-25': { type: 'run', title: 'Intervals', badge: '55-65 min', content: '8x 600m @ race pace\nRest: 75s\nBig aerobic session' },
  '2026-07-28': { type: 'strength', title: 'Hyrox Simulation 80%', badge: '100-120 min', content: '80% Hyrox Simulation:\n\nRun 1km → SkiErg: 800m\nRun 1km → Sled Push: 4x25m\nRun 1km → Sled Pull: 4x25m\nRun 1km → Burpees: 65 BW\nRun 1km → Row: 800m\nRun 1km → Farmer Carry: 160m @ 32kg/hand\nRun 1km → Lunges: 80m @ 30kg\nRun 1km → Wall Balls: 80 @ 9kg\n\nTarget: Strong, controlled\nNote weak points for race day' },
  '2026-07-27': { type: 'run', title: 'Long Run', badge: '80-90 min', content: 'Zone 2: 90-100 min\nLast long run before taper' },
...
export const monthlyGoals = {
  2: { // March (index 2)
    ...
    keyLifts: { 'Seated Row': '35→37.5kg', 'Lat Pulldown': '40→42.5kg', 'Chest Press': '40kg', 'Hip Thrust': '60kg' },
  },
  3: { // April
    ...
    keyLifts: { 'Seated Row': '40→47.5kg', 'Lat Pulldown': '45→52.5kg', 'Chest Press': '42.5→47.5kg', 'Hip Thrust': '65→75kg' },
  },
  4: { // May
    ...
    keyLifts: { 'Seated Row': '50kg PEAK', 'Lat Pulldown': '55kg', 'Chest Press': '50kg', 'Hip Thrust': '80kg' },
  },
  5: { // June
    ...
    keyLifts: { 'Seated Row': '50→57.5kg', 'Lat Pulldown': '55→62.5kg', 'Chest Press': '50→57.5kg', 'Hip Thrust': '85→100kg' },
  },
  6: { // July
    ...
    keyLifts: { 'Seated Row': '60→62.5kg', 'Lat Pulldown': '65→67.5kg', 'Chest Press': '60→62.5kg', 'Hip Thrust': '105→110kg' },
  },
  7: { // August
    ...
    keyLifts: { 'Seated Row': '55kg (taper)', 'Lat Pulldown': '60kg (taper)', 'Chest Press': '35-60kg', 'Hip Thrust': '60kg (taper)' },
  },
};

// Weekly weight progression: key lifts per week (week start date → weights)
export const weeklyProgression = [
  { week: '24-30 มี.ค.', row: 35, lat: 40, chest: 40, hip: 60 },
  { week: '31 มี.ค.-6 เม.ย.', row: 37.5, lat: 42.5, chest: 42.5, hip: 65 },
  { week: '7-13 เม.ย.', row: null, lat: null, chest: null, hip: null, note: 'No Gym Week' },
  { week: '14-20 เม.ย.', row: 42.5, lat: 47.5, chest: 45, hip: 70 },
  { week: '21-27 เม.ย.', row: 45, lat: 50, chest: 47.5, hip: 75 },
  { week: '28 เม.ย.-4 พ.ค.', row: 47.5, lat: 52.5, chest: null, hip: null, note: 'Sim week' },
  { week: '5-11 พ.ค.', row: 50, lat: 55, chest: 50, hip: 80, note: 'PEAK' },
  { week: '12-18 พ.ค.', row: 40, lat: 45, chest: 40, hip: 60, note: 'Taper' },
  { week: '19-25 พ.ค.', row: null, lat: null, chest: null, hip: null, note: 'Crucible Race' },
  { week: '26-31 พ.ค.', row: 35, lat: 40, chest: 40, hip: 60, note: 'Recovery' },
  { week: '1-7 มิ.ย.', row: 50, lat: 55, chest: 50, hip: 85 },
  { week: '8-14 มิ.ย.', row: 52.5, lat: 57.5, chest: 52.5, hip: 90 },
  { week: '15-21 มิ.ย.', row: 55, lat: 60, chest: 55, hip: 95, note: 'MILESTONE' },
  { week: '22-28 มิ.ย.', row: 57.5, lat: 62.5, chest: 57.5, hip: 100 },
  { week: '29 มิ.ย.-5 ก.ค.', row: 60, lat: 65, chest: 60, hip: 105, note: 'TARGET' },
  { week: '6-12 ก.ค.', row: 62.5, lat: 67.5, chest: 62.5, hip: 110 },
  { week: '13-19 ก.ค.', row: null, lat: null, chest: null, hip: null, note: 'Recovery' },
  { week: '20-26 ก.ค.', row: 55, lat: 60, chest: null, hip: null, note: 'Maintain' },
  { week: '27 ก.ค.-2 ส.ค.', row: 60, lat: 65, chest: 60, hip: 110, note: 'Final Build' },
  { week: '3-9 ส.ค.', row: 55, lat: 60, chest: 35, hip: 60, note: 'Taper' },
