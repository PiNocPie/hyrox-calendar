...
export const workouts = {
  ...
  '2026-05-02': { type: 'strength', title: 'Strength - Mixed (AM/PM)', badge: 'AM 45-50 / PM 30 min', content: '🎯 ฝึก stations จริง — ร่างกายชินกับอุปกรณ์แข่ง\n\nAM — Sled + Carry (คนน้อย setup สะดวก)\n⏱ พัก: Sled 120s / Carry 90s\n\nSled Push: 4x30m @ 175kg\nSled Pull: 4x30m @ 120kg\nFarmer Carry: 3x50m @ 28kg/hand\n\nPM — Strength + Bodyweight\n⏱ พัก: อื่นๆ 60s\n\nChest Press: 3x12 @ 45kg\nSeated Row: 3x10 @ 45kg\n\nEMOM 12 min (rotate):\nMin 1 — Wall Balls: 15 @ 9kg (alt: 6kg / DB Thruster)\nMin 2 — Burpees: 8 BW\nMin 3 — Run: 150m\n\nCore:\nHanging Knee Raise: 3x10 BW\n\nTransition Drill:\nRun 400m → Burpees 20 → Run 400m' },
